...
apt upgrade -y
# General installs
apt install tmux man fish nano emacs htop git openssh-server
systemctl enable ssh
systemctl start ssh
# Python dev installs
apt install python3 python3-pip python3-dev virtualenv python3-numpy python3-pandas python3-matplotlib python3-pip
# C dev installs
apt install cmake make gdb build-essential g++ libc6-dev valgrind libczmq4 libczmq-dev libliquid1 libliquid-dev
# MCU installs
